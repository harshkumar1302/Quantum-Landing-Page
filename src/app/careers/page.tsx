...
export default function CareersPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#000000] text-black dark:text-white pt-40 pb-24 px-4 md:px-8 transition-colors duration-500 overflow-hidden relative">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        {/* Header */}
        <div className="mb-24 flex flex-col items-center text-center gap-6 border-b border-black/5 dark:border-white/5 pb-24">
           <motion.div 
